...
public class SandboxConjuntos
{
    ...
    {
    	NavigableSet<String> subConjunto = arbolCadenas.tailSet(cadena, true);
    	
        return new ArrayList<>(subConjunto);
    }
    ...
    {
    	NavigableSet<String> arbolTemp = new TreeSet<String>();
    	
    	for(Object objeto : objetos) {
    		arbolTemp.add(objeto.toString());
    	}
    ...
    {
    	TreeSet<String> arbolTemp = new TreeSet<String>();
    	for(String cadena : arbolCadenas) {
    		arbolTemp.addFirst(cadena);
    	}
    	return arbolTemp;
    }
